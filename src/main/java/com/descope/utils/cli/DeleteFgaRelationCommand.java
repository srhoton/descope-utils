 ...
 *
 * <p>Removes authorization relationships between targets and resources using the Descope
  ...
  public void run() {
    try {
      ...
      if (file != null) {
        ...
        logger.info("Deleting single FGA relation tuple");
        tuples =
            Collections.singletonList(
                new FgaRelationModel(resource, resourceType, relation, target, targetType));
      }

      OperationResult<String> result = fgaService.deleteRelations(config, tuples);

...
@Command(
    ...
    subcommands = {
      ...
      ImportFgaRelationsCommand.class,
      SaveFgaSchemaCommand.class,
      LoadFgaSchemaCommand.class,
      SaveFgaResourceDetailsCommand.class,
      LoadFgaResourceDetailsCommand.class,
